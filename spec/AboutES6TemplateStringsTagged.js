...
describe('tagged template strings, are an advanced form of template strings', () => {

  it('syntax: prefix the template string with a function to call (without "()" around it)', () => {
  ...
  describe('the function can access each part of the template', () => {
    ...
    describe('the 2nd and following parameters - contain the values of the processed substitution', () => {

      var one = 1;
      var two = 2;
      var three = 3;

      it('the 2nd parameter contains the first expression`s value', () => {
      ...
      it('the 3rd parameter contains the second expression`s value', () => {
      ...
      it('using ES6 rest syntax, all values can be accessed via one variable', () => {
