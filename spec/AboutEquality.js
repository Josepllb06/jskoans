describe("About Equality", () => {
  ...
  it("equality without type coercion", () => {
    expect(3 == FILL_ME_IN).withContext('what string is equal to 3, without type coercion?').toBeTruthy();
  });

  it("string literals", () => {
    expect("frankenstein").withContext("quote types are interchangable, but they must match.").toEqual(FILL_ME_IN);
