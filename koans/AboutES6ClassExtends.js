...
describe('Classes can inherit from another using `extends`', () => {
  describe('the default super class is `Object`', () => {
    it('a `class A` is an instance of `Object`', () => {
      let A
      expects(new A() instanceof FILL_ME_IN).toBeTruthy();
    });

    it('when B extends A, B is also instance of `Object`', () => {
      class A {}
      class B extends A {}
      expects(new B() instanceof FILL_ME_IN).toBeTruthy();
      expects(new B() instanceof FILL_ME_IN).toBeTruthy();
    });
    ...
    it('a class can extend `null`, and is not an instance of Object', () => {
      ...
      expects(nullInstance instanceof Object).toEqual(FILL_ME_IN);
    });
  });
  ...
  describe('instance of', () => {
    ...
    it('extend over multiple levels', () => {
      ...
      class B extends A {}
      class C extends B {}
      expects(new C instanceof A).toEqual(FILL_ME_IN);
    });
  });
});
