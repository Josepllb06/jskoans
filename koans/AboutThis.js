describe("About this", () => {
    it("'this' inside a method", () => {
        ...
        expect(person.intro()).toEqual("Hello, my name is bob").withContext("If an object has a method can you access properties inside it?");
    });
    ...
    it("'this' on unattached function", () => {
        ...
        expect(alias()).toEqual("Hello, my name is Peter").withContext("What does 'this' refer to when it is not part of an object?");
    });
    ...
    it("'this' set explicitly", () => {
        ...
        expect(message).toEqual( "Hello, my name is Frank").withContext("What does 'this' refer to when you use the 'call()' method?");
    });
