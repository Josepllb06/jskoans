...
describe('The object literal allows for new shorthands', () => {
  ...
  describe('with variables', () => {
    it('the short version for `{x: x}` is {x}', () => {
      ...
      expects(short).toEqual({x: 1});
    });

    it('works with multiple variables too', () => {
      const short = {FILL_ME_IN, FILL_ME_IN};
      expects(short).toEqual({x: 1, y: 2});
    });
  });
  ...
  describe('with methods', () => {
    ...
    it('using the name only uses it as key', () => {
      const short = {FILL_ME_IN};
      expects(short).toEqual({func: func});
    });

    it('a different key must be given explicitly, just like before ES6', () => {
      const short = {FILL_ME_IN: func};
      expects(short).toEqual({otherKey: func});
    });
    ...
    it('inline functions, can written as `obj={func(){}}` instead of `obj={func:function(){}}`', () => {
      ...
      expects(short.inlineFunc()).toEqual(FILL_ME_IN);
    });
  });
});
